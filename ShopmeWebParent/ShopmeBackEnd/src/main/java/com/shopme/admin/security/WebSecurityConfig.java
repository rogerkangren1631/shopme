...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// declare Spring bean for the password encoder
	@Bean
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
		    .antMatchers("/states/list_states_by_country/**").hasAnyAuthority("Admin","Salesperson")
			...
			.and().rememberMe()
				.key("AbcddefgHijklmNopqsY_1234567890").tokenValiditySeconds(5 * 24 * 60 * 60);
